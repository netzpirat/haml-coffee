(function() {
  ...
  module.exports = Filter = (function() {
    ...
    Filter.prototype.render = function() {
      var cdata, child, css, js, output, plain, preserve, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _len6, _len7, _m, _n, _o, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
      if (this.parentNode instanceof Filter) return this.content;
      output = [];
      switch (this.filter) {
        case 'escaped':
          _ref = this.children;
