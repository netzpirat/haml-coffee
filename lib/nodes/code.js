(function() {
  ...
  module.exports = Code = (function() {
    ...
    Code.prototype.render = function() {
      ...
      output = '';
      if (this.identifier === '-') {
        output += this.outputCode(this.code);
      } else if (this.identifier === '~') {
        output += this.outputCodeHtml(this.findAndPreserve(this.code));
      } else if (this.identifier === '&=' || (this.identifier === '=' && this.escapeHtml)) {
        output += this.outputCodeHtml(this.code, true);
      } else {
        output += this.outputCodeHtml(this.code);
      }
      return output;
    };
