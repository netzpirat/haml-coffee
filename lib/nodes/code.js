(function() {
  ...
  module.exports = Code = (function() {
    ...
    Code.prototype.render = function() {
      ...
      output = '';
      if (this.identifier === '-') {
        output += this.outputRunningCode(this.code);
      } else if (this.identifier === '~') {
        output += this.outputInsertingCode(this.findAndPreserve(this.code));
      } else if (this.identifier === '&=' || (this.identifier === '=' && this.escapeHtml)) {
        output += this.outputInsertingCode(this.code, true);
      } else {
        output += this.outputInsertingCode(this.code);
      }
      return output;
    };
