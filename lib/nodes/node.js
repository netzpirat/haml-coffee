(function() {
  ...
  module.exports = Node = (function() {
    ...
    Node.prototype.outputInsertingCode = function(code, escape) {
      ...
      htmlIndention = this.getHtmlIndention();
      if (htmlIndention.length === 0) {
        return "" + this.codeWhitespace + "o.push " + (escape ? 'e ' : '') + code + "\n";
      } else {
        return "" + this.codeWhitespace + "o.push " + (escape ? 'e' : '') + " \"" + (this.getHtmlIndention()) + "\" + " + code + "\n";
      }
    };
