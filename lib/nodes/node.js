(function() {
  ...
  module.exports = Node = (function() {
    ...
    Node.prototype.applyWhitespaceRemoval = function() {
      ...
      if (this.wsRemoval === '<') this.newline = false;
      if (this.wsRemoval === '>') return this.applySurroundingWhitespaceRemoval();
    };
    ...
    Node.prototype.applySurroundingWhitespaceRemoval = function() {
      ...
      if ((_ref = siblings[position - 1]) != null) _ref.newline = false;
      this.newline = false;
      if ((_ref2 = siblings[position + 1]) != null) _ref2.newline = false;
      if (!siblings[position - 1]) return this.parentNode.newline = false;
    };
