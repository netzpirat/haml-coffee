(function() {
  ...
  module.exports = Compiler = (function() {
    ...
    function Compiler(options) {
      var _base, _base2, _base3, _base4, _base5, _ref, _ref2, _ref3, _ref4, _ref5;
      ...
      if ((_ref4 = (_base4 = this.options).preserveTags) == null) {
        _base4.preserveTags = 'pre,textarea';
      }
      if ((_ref5 = (_base5 = this.options).selfCloseTags) == null) {
        _base5.selfCloseTags = 'meta,img,link,br,hr,input,area,param,col,base';
      }
    }
